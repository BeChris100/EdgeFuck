...
import EdgeFuck_Commons.utils.io.FileUtil;
...
public class RuntimeEnvironment {
            ...
            if (isLinux()) {
                try {
                    if (FileUtil.exists("/etc/hostname"))
                        return new String(FileUtil.readChars("/etc/hostname"));
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
    ...
    public static class LinuxEnvironment {
        ...
        public static String getName() {
            try {
                String contents = new String(FileUtil.readChars("/etc/os-release"));
