...
public class FileUtil {
    ...
    public static void writeChars(String filePath, char[] chars) throws IOException {
        File file = new File(filePath);
    ...
    public static void writeString(String filePath, String contents) throws IOException {
        File file = new File(filePath);
